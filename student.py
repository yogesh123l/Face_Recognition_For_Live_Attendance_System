...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Bsc","B.Tech","MCA","Bsc AIML","BCA")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","FY","SY","TY","Final Year")
        cou_combo.current(0)
        ...
        #Roll No
        student_roll_label = Label(class_Student_frame,text="PRN:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Fact. Name:",font=("verdana",12,"bold"),fg="navyblue",bg="white")
        ...
        self.student_table.heading("Roll-No",text="PRN")
